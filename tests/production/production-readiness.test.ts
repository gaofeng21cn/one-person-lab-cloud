...
const tkeProductionEnv = {
  ...
  OPL_APPLICATION_DOMAIN: "apps.example.com",
  OPL_APPLICATION_INGRESS_EXISTING_LB_ID: "lb-example01",
  OPL_APPLICATION_INGRESS_TLS_SECRET: "applications-wildcard-tls",
