...
| Domain skills and reference packs | Domain owner packages installed through OPL Packages; Connect only supplies shared access |
...
6. Domain skills keep domain truth; OPL Packages owns their install/lock
   lifecycle; Connect stabilizes shared access and Ledger records provenance.
