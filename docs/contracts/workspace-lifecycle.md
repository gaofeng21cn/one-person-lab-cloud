...
| --- | --- | --- |
| Create | Provision the account's initial Workspace with permitted package refs, compute, storage, and access policy | Console policy; package state remains OPL Packages |
...
update, roll back, repair, or rewrite an OPL Package lock; those actions route
to OPL Packages.
