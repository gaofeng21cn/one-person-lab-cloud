...
| `WORKSPACE-REGISTRY-ENDPOINT-OWNERSHIP-01` | 镜像目录的写入者明确为安装方：端点与浏览凭据由 Instance 提供，Cloud 无默认值、无匿名降级。 | Instance 提供端点与 Secret 注入；Control Plane 消费；Fabric 保持自己的拉取绑定。 | 2 |
