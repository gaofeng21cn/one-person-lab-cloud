...
`branding/opl-gateway-logo-80.png` and `branding/opl-gateway-logo-source.png`
are OPL Gateway brand assets managed under the OPL Cloud public brand surface.
