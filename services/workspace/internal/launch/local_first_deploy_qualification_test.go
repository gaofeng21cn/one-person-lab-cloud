...
func TestLocalFirstApplicationDeploymentQualification(t *testing.T) {
	...
	serveEnv := qEnv(common, map[string]string{"DATABASE_URL": serveHarness.OwnerDSN, "OPL_SERVE_ADDR": sa, "OPL_SERVE_PEER_TOKENS": qPeers("workspace", "capability", "console-bff"), "OPL_CAPABILITY_ADDR": capa, "OPL_CAPABILITY_TOKEN": livePeerToken, "OPL_FABRIC_COORDINATION_ADDR": fa, "OPL_FABRIC_COORDINATION_TOKEN": livePeerToken, "OPL_FABRIC_APPLICATION_URL": "http://" + fh, "OPL_FABRIC_SERVE_SERVICE_TOKEN": serveToken, "OPL_FABRIC_SERVE_CAPABILITY_KEY": serveKey})
