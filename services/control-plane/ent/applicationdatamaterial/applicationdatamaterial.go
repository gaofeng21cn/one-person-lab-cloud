...
const (
	// Label holds the string label denoting the applicationdatamaterial type in the database.
	Label = "application_data_material"
	...
	// Table holds the table name of the applicationdatamaterial in the database.
	Table = "control_plane_application_data_materials"
)

// Columns holds all SQL columns for applicationdatamaterial fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ApplicationDataMaterial queries.
